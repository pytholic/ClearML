...
# Define tehr network architecture
class Net(nn.Module):
    def __init__(self):
        super().__init__()
...
def main():
    ...
    task = Task.init(
        ...
        task_name=f"PyTorch-CIFAR10-train-100epochs-{datetime.now()}",
    )
    ...
    # train_subset = torch.utils.data.Subset(trainset, indices=range(64))
